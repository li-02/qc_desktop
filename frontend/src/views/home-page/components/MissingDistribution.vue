...
const topMissing = computed<BarItem[]>(() => {
  ...
  // columnStats may have columnMissingStatus nested or be a flat map
  const missingMap: Record<string, number> = colStats.columnMissingStatus ?? colStats;
...
<template>
  <div class="missing-card">
    ...
    <div class="card-body">
      <div v-if="topMissing.length === 0" class="empty-hint">暂无缺失值数据</div>
